...
class StringObfuscationPass: public IStringObfuscation {
public:
...
IStringObfuscation&& llvm::createStringObfuscation(bool flag) {
    return std::move(StringObfuscationPass(flag));
}
